...
#ifndef ARK_CRYPTO_C_PRIMITIVES_BASE58_H
#define ARK_CRYPTO_C_PRIMITIVES_BASE58_H
...
////////////////////////////////////////////////////////////////////////////////
int base58Encode(const uint8_t *data, size_t datalen, char *str, size_t *strlen);

int base58Decode(const char *str, size_t strLen, uint8_t *data, size_t *dataLen);

#ifdef __cplusplus
}
#endif  // #ifdef __cplusplus

#endif  // #define ARK_CRYPTO_C_PRIMITIVES_BASE58_H
